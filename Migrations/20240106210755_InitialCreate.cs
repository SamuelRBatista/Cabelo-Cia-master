    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AppointmentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    AppointmentClient = table.Column<string>(type: "varchar(80)", maxLength: 80, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_CategoryServices_CategoryServiceId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "C#", "samuka-srb@live.com", 23, "Samuel" });

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_CategoryServiceId",
                table: "Appointments",
